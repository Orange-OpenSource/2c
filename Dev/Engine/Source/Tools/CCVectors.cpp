...
const bool CCVector3::toTarget(const float target, const float speed)
{
...
const bool CCVector3::toTarget(const CCVector3 &target, const float speed)
{
...
const bool CCVector3::toTarget(const CCVector3 &target, const float speedX, const float speedY, const float speedZ)
{
...
const bool CCColour::toTarget(const CCColour &target, const float amount)	
{
