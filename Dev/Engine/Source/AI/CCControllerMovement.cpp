...
CCControllerMovement::CCControllerMovement(CCSceneCollideable *inObject)
{
    object = inObject;
...
const bool CCControllerMovement::update(const float delta)
{
    if( findingTarget )
    {
        // Target
...
const float CCControllerMovement::applyMovementDirection()
{
