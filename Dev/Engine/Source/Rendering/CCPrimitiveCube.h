...
public:
	...
	void setup(const float bottomDepth, const float topDepth, const float bZ, const float tZ, const float y, const float height, const float bL, const float bR, const float tL, const float tR);	
};
